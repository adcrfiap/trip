...
public class GetTripRecordByCountry implements RequestHandler<HandlerRequest, HandlerResponse> {
    ...
    public HandlerResponse handleRequest(HandlerRequest request, Context context) {
        ...
        try {
            ...
            context.getLogger().log("Searching records from country " + country );
